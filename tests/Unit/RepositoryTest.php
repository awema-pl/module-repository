...
namespace AwemaPL\Repository\Tests\Unit;
...
use AwemaPL\Repository\Tests\Stubs\Repository;
use Illuminate\Contracts\Pagination\Paginator;
use AwemaPL\Repository\Tests\Stubs\InvalidRepository;
...
class RepositoryTest extends TestCase
{
    ...
    public function it_can_smart_paginate_by_limit_parameter_if_its_less_or_equals_max_limit()
    {
        ...
        request()->merge([
            config('awemapl-repository.smart_paginate.request_parameter') => $limit = random_int(
                1, config('awemapl-repository.smart_paginate.max_limit')
            )
        ]);
    ...
    public function it_can_smart_paginate_by_max_limit()
    {
        ...
        request()->merge([
            config('awemapl-repository.smart_paginate.request_parameter') => $limit = random_int(
                $max = config('awemapl-repository.smart_paginate.max_limit'), $max + 1000
            )
        ]);
    ...
    public function it_can_smart_paginate_if_request_parametert_is_string()
    {
        ...
        request()->merge([
            config('awemapl-repository.smart_paginate.request_parameter') => 'string'
        ]);
